...
RcppExport SEXP _easy_NN_rcpp_knn_to_sparse_weights(SEXP knn_indexSEXP, SEXP knn_distSEXP, SEXP self_loopsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _easy_NN_rcpp_knn_to_sparse_idx(SEXP knn_indexSEXP, SEXP self_loopsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix& >::type knn_index(knn_indexSEXP);
    Rcpp::traits::input_parameter< bool >::type self_loops(self_loopsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_easy_NN_rcpp_knn_to_sparse_weights", (DL_FUNC) &_easy_NN_rcpp_knn_to_sparse_weights, 3},
    {"_easy_NN_rcpp_knn_to_sparse_idx", (DL_FUNC) &_easy_NN_rcpp_knn_to_sparse_idx, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_easy_NN(DllInfo *dll) {
